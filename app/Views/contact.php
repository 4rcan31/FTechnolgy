...
<body>
  ...
  <main>
      ...
      <div class="d-flex container-fluid flex-wrap px-2 justify-content-center">
        <div class="card my-2 mx-2" style="width: 21rem;">
          <div class="card-body">
            ...
            <a href="https://instagram.com/_ftechnology?igshid=ZDc4ODBmNjlmNQ==" target="_blank" class="btn btn-outline-secondary col-12 social-btn" tabindex="-1" role="button" aria-disabled="true">
        ...
        <div class="card my-2 mx-2" style="width: 21rem;">
          <div class="card-body">
            ...
            <a href="" target="_blank" class="btn btn-outline-secondary col-12 social-btn" tabindex="-1" role="button" aria-disabled="true">
        ...
        <div class="card my-2 mx-2" style="width: 21rem;">
          <div class="card-body">
            ...
            <a href="https://twitter.com/ftechnology495" target="_blank" class="btn btn-outline-secondary col-12 social-btn" tabindex="-1" role="button" aria-disabled="true">
        ...
        <div class="card my-2 mx-2" style="width: 21rem;">
          <div class="card-body">
            ...
            <a href="https://youtube.com/@FTechnology" target="_blank" class="btn btn-outline-secondary col-12 social-btn" tabindex="-1" role="button" aria-disabled="true">
        ...
        <div class="card my-2 mx-2" style="width: 21rem;">
          <div class="card-body">
            ...
            <a href="ftechnology495@gmail.com" target="_blank" class="btn btn-outline-secondary col-12 social-btn" tabindex="-1" role="button" aria-disabled="true">
    ...
    <div class="container">
      <h3 class="programa">Mandanos un mensaje</h3>
